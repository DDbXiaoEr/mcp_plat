...
> **个人说明**：本项目当前所有修改均由 AI 完成。作者去年因脑出血导致偏瘫，目前只有一只手可用，因此许多功能尚未实现。每天需前往医院进行康复，时间和精力有限。没有工作和收入，token 完全依赖各平台的免费新用户额度和邀请奖励，开发效率已达极限，欢迎 token 充裕的朋友贡献。感谢 GLM 与阿里云百炼。
